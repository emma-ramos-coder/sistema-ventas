<div class="box box-info padding-1">
    <div class="box-body">
        ...
        <div class="form-group">
            ...
            {{ Form::text('sale_price', $article->sale_price, ['class' => 'form-control' . ($errors->has('sale_price') ? ' is-invalid' : ''), 'placeholder' => 'Precio de venta']) }}
            {!! $errors->first('sale_price', '<div class="invalid-feedback">:message</div>') !!}
        </div>
        <div class="form-group">
            {{ Form::label('Precio de costo') }}
            {{ Form::text('cost_price', $article->cost_price, ['class' => 'form-control' . ($errors->has('cost_price') ? ' is-invalid' : ''), 'placeholder' => 'Precio de costo']) }}
        ...
        <div class="form-group">
            ...
            {{ Form::text('admission_date', $article->admission_date, ['class' => 'form-control' . ($errors->has('admission_date') ? ' is-invalid' : ''), 'placeholder' => 'Fecha de ingreso']) }}
